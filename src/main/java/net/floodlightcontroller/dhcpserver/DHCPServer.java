...
public class DHCPServer implements IOFMessageListener, IFloodlightModule  {
    ...
    public void startUp(FloodlightModuleContext context) {
        ...
        try {
            ...
            DHCP_SERVER_DHCP_SERVER_IP = IPv4.toIPv4AddressBytes(IPv4.fromIPv4Address(CONTROLLER_IP));
    ...
    public net.floodlightcontroller.core.IListener.Command receive(
        ...
        if (eth.getEtherType() == Ethernet.TYPE_IPv4) {
            ...
            if (IPv4Payload.getProtocol() == IPv4.PROTOCOL_UDP) {
                ...
                {
                    log.debug("Got DHCP Packet from " + IPv4.fromIPv4Address(IPv4SrcAddr));
                    ...
                    if (DHCPPayload.getOpCode() == DHCP_OPCODE_REQUEST) {
                         ...
                         **/
                            ...
                            for(final byte b: chaddr)
                                sb.append(String.format("%02x ", b&0xff));
                            log.debug(": DHCP REQUEST received : " + sb.toString());
